...
typedef NS_ENUM(NSUInteger, WZReachabilityStatus) {
    WZReachabilityStatusNone  = 0, ///< Not Reachable
    WZReachabilityStatusWWAN  = 1, ///< Reachable via WWAN (2G/3G/4G)
    WZReachabilityStatusWiFi  = 2, ///< Reachable via WiFi
};

typedef NS_ENUM(NSUInteger, WZReachabilityWWANStatus) {
    WZReachabilityWWANStatusNone  = 0, ///< Not Reachable vis WWAN
    WZReachabilityWWANStatus2G = 2, ///< Reachable via 2G (GPRS/EDGE)       10~100Kbps
    WZReachabilityWWANStatus3G = 3, ///< Reachable via 3G (WCDMA/HSDPA/...) 1~10Mbps
    WZReachabilityWWANStatus4G = 4, ///< Reachable via 4G (eHRPD/LTE)       100Mbps
};


/**
 `WZReachability` can used to monitor the network status of an iOS device.
 */
@interface WZReachability : NSObject

@property (nonatomic, readonly) SCNetworkReachabilityFlags flags;                           ///< Current flags.
@property (nonatomic, readonly) WZReachabilityStatus status;                                ///< Current status.
@property (nonatomic, readonly) WZReachabilityWWANStatus wwanStatus NS_AVAILABLE_IOS(7_0);  ///< Current WWAN status.
...
@property (nullable, nonatomic, copy) void (^notifyBlock)(WZReachability *reachability);

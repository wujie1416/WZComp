//
//  WZURLSessionWrapperOperation.m
//  AFNetworking
//
...
@interface WZURLSessionWrapperOperation () {
...
@implementation WZURLSessionWrapperOperation

#pragma mark - Observe Task

+ (instancetype)operationWithURLSessionTask:(NSURLSessionTask*)task {
    WZURLSessionWrapperOperation* operation = [WZURLSessionWrapperOperation new];
    operation.task = task;
    return operation;
}

...
// 空白页区域点击
@property (nonatomic, copy) void(^emptyViewTapBlock)(void);

// 按钮点击
@property (nonatomic, copy) void(^emptyBtnClickBlock)(void);

// 空白页的图片是否执行动画: default YES
@property (nonatomic, copy) BOOL(^shouldStartImageViewAnimate)(void);
...
// life cricle
@property (nonatomic, copy) void(^emptyViewWillAppear)(void);
@property (nonatomic, copy) void(^emptyViewWillDisappear)(void);
@property (nonatomic, copy) void(^emptyViewDidAppear)(void);
@property (nonatomic, copy) void(^emptyViewDidDisappear)(void);
